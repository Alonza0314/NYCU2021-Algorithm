...
std::string command,insert_key,insert_value,find_key,erase_key,enum_key1,enum_key2;
bool szlow_flag;
...
void splaytree::insert()
{
    ...
    while(cur!=nullptr)
    {
        ...
        {
            std::string str="INSERT "+insert_key+" FAIL!\n";
            output<<str;
            return;
        }
    }
    ...
    std::string str="INSERT "+insert_key+" SUCCESS!\n";
    output<<str;
    splay(temp);
}
void splaytree::find()
{
    ...
    {
        splay(cur);
        std::string str="FIND "+cur->key+":"+cur->value+"!\n";
        output<<str;
    }
    else
    {
        std::string str=find_key+" NOT FOUND!\n";
        output<<str;
    }
}
void splaytree::erase()
{
    ...
    if(dest==nullptr)
    {
        std::string str="ERASE "+erase_key+" FAIL!\n";
        output<<str;
        return;
    }
    splay(dest);
    ...
    std::string str="ERASE "+erase_key+" SUCCESS!\n";
    output<<str;
}
void splaytree::enum_()
{
    ...
    if(start==nullptr&&end==nullptr)
    {
        ...
        while(cur!=nullptr||s.empty()==false)
        {
            ...
            cur=s.top();
            s.pop();
            std::string str="ENUM "+cur->key+":"+cur->value+"\n";
            output<<str;
            cur=cur->right;
        }
    }
